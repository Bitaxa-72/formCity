...
По текущей политике все импортированные поля непроектных расходов участвуют в пользовательской выдаче: категории, статьи, строки, суммы, периоды, типы строк и исходные текстовые обозначения.
