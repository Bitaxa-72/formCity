...
модель ФМ апрель
модель ФМ план апрель
модель NEWKPI апрель
модель NEWKPI план апрель
модель паспорт апрель
модель проценты апрель
модель сравнение апрель
модель остатки апрель
модель для консолидации апрель
...
```text
raw_sheet - ФМ / ФМ план / NEWKPI / NEWKPI план / Паспорт / Проценты / Сравнение / Финмодель / Остатки / Для консолидации
