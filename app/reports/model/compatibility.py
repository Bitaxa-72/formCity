...
MODEL_HELP_MESSAGE = (
    "В модели доступны KPI и безопасные строки загруженных листов.\n\n"
    "Можно запросить:\n"
    "- выручку\n"
    ...
    "- ПИР\n\n"
    "Также можно спросить: доступные показатели модели, доступные срезы модели, листы исходной модели или строки листов ФМ, ФМ план, NEWKPI, NEWKPI план, Паспорт, Проценты, Сравнение, Финмодель, Остатки, Для консолидации."
)
