...
MODEL_HELP_MESSAGE = (
    ...
    "- ПИР\n\n"
    "Также можно спросить: доступные показатели модели, доступные срезы модели, raw-листы модели или строки листов ФМ, ФМ план, NEWKPI, NEWKPI план, Паспорт, Проценты, Сравнение, Финмодель, Остатки, Для консолидации."
)
