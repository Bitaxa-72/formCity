...
CAPABILITIES_TEXT = (
    ...
    "Отчет по агентам:\n"
    "- проект: Обводный;\n"
    "- можно смотреть безопасные агрегаты: сделки, площадь, агентское вознаграждение, оплаты, остаток, суммы ДДУ, уступки и графики оплат.\n\n"
    "Сводный отчет:\n"
    "- проекты: Московский, Обводный, Евгеньевский;\n"
    "- можно смотреть безопасный обзор файлов, листов, строк, ячеек, типов листов, колонок и суммы по безопасным числовым колонкам.\n\n"
