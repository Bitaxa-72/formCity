...
CAPABILITIES_TEXT = (
    ...
    "- сводный отчет.\n\n"
    "Как спрашивать:\n"
    "- укажите отчет, проект, показатель и период, если они важны;\n"
    "- если проект не указан, покажу данные по доступным проектам отдельно;\n"
    "- если период не указан в платежном календаре, возьму весь доступный период;\n"
    "- если период не указан в дорожной карте, модели и остатках в продаже, возьму последний актуальный месяц.\n\n"
    "Примеры:\n"
    "- платежный календарь московский план по ФОТ за май;\n"
    "- модель NPV апрель;\n"
    "- ДЗ и брони суммы за май."
)
