...
from app.llm_input import build_dialog_state, build_last_result_summary, build_llm_input
...
def test_build_last_result_summary_keeps_known_sections() -> None:
    ...
    assert summary["project"] == "obvodny_118"
...
def test_build_llm_input_collects_message_state_history_and_last_result() -> None:
    ...
    assert llm_input.dialog_state.project == "obvodny_118"
